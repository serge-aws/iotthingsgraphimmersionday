...
mkdir LAB1
for Item in cloudcamera.py cloudms.py cloudscreen.py deleteIotThings.sh provisionIotThings.sh;
  do
    FILE_NAME=$Item
    # Copy File here
...
for Item in provisionLab2Things.sh ACTION_activity.gql ACTION_finished.gql Button.py Camera.py EVENT_activity.gql EVENT_finished.gql LAMBDA_activity.gql LAMBDA_finished.gql LED.py labFlow.gql readGaugeLambda.py;
